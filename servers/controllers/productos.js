...
function selectProducts(req, res) {
  let sql = "SELECT * FROM delilahrestocamilo.productos";
...
function insertProduct(req, res) {
  ...
  if (userRol == 1) {
    sql = `INSERT INTO delilahrestocamilo.productos(product_name, price, stock, img_url, category)
...
function updateProduct(req, res) {
  ...
  if (userRol == 1) {
    sql = `UPDATE delilahrestocamilo.productos
